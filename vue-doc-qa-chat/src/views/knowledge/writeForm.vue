 ...
 * 支持的文件扩展名
 */
const supportedExtensions = ['pdf', 'txt', 'doc', 'docx', 'md', 'json', 'csv']

/**
 * 检查文件类型
 * 支持格式：pdf, txt, doc, docx, md, json, csv
    ...
    <el-form ref="docFormRef" :model="docForm" :rules="rules" label-width="120px" status-icon>
      ...
      <el-form-item label="上传文件" prop="file_name">
        ...
        >
          ...
          <div class="upload-text">拖动或 <em>点击上传</em></div>
          <div class="upload-tip">支持 .pdf, .txt, .doc, .docx, .md, .json, .csv 格式</div>
        </el-upload>
      </el-form-item>
    </el-form>
